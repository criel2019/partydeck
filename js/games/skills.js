...
const SKILL_DEFS = [
  {
    ...
    unlock: { game: 'fortress', type: 'play', count: 10, label: '포트리스 10번 플레이' },
    games: ['fortress'],
  },
  {
    id: 'bounce',  name: '바운스탄', emoji: '🏀',
    desc: '벽과 지형에 최대 3회 튕기는 포탄입니다.',
    unlock: { game: 'fortress', type: 'play', count: 20, label: '포트리스 20번 플레이' },
    games: ['fortress'],
  },
  {
    id: 'sniper',  name: '저격탄', emoji: '🎯',
    desc: '사거리 무제한, 바람 영향 없음.',
    unlock: { game: 'quickdraw', type: 'play', count: 50, label: '빠른총뽑기 50번 플레이' },
    games: ['fortress'],
  },
  {
  ...
  },
  {
    ...
    unlock: { game: 'poker', type: 'play', count: 30, label: '포커 30번 플레이' },
    games: ['fortress'],
  },
  {
    id: 'knockback',  name: '넉백탄', emoji: '💨',
    desc: '맞은 적을 크게 날려버립니다.',
    unlock: { game: 'bombshot', type: 'play', count: 30, label: '폭탄샷 30번 플레이' },
    games: ['fortress'],
  },
  {
    id: 'split',  name: '분열탄', emoji: '🌟',
    desc: '날아가다 3발로 분열합니다.',
    unlock: { game: 'mafia', type: 'play', count: 100, label: '마피아 100번 플레이' },
    games: ['fortress'],
  },
  {
  ...
  },
  {
    ...
    unlock: { game: 'drinkpoker', type: 'win', count: 100, label: '폭탄주 100번 승리' },
    games: ['fortress'],
  },
  {
    id: 'double_pierce',  name: '땅 두 번 뚫기', emoji: '🔩',
    desc: '지형을 2번 관통하는 포탄입니다.',
    unlock: { game: 'slinky', type: 'play', count: 200, label: '슬링키 200번 플레이' },
    games: ['fortress'],
  },
  {
    id: 'cluster',  name: '클러스터', emoji: '💣',
    desc: '착탄 후 주변에 소형 폭탄을 산포합니다.',
    unlock: { game: 'fortress', type: 'play', count: 50, label: '포트리스 50번 플레이' },
    games: ['fortress'],
  },
  {
    id: 'ice',  name: '빙결탄', emoji: '❄️',
    desc: '맞은 적을 1턴 행동 불가로 만듭니다.',
    unlock: { game: 'yahtzee', type: 'win', count: 100, label: '야추 100번 승리' },
    games: ['fortress'],
  },
  {
    id: 'triple_pierce',  name: '땅 세 번 뚫기', emoji: '🔱',
    desc: '지형을 3번 관통하는 포탄입니다.',
    unlock: { game: 'fortress', type: 'play', count: 100, label: '포트리스 100번 플레이' },
    games: ['fortress'],
  },
];
